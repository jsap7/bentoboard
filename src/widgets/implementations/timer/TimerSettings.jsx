    ...
    <BaseWidgetSettings onClose={onClose} title="Timer Settings">
      <div className="settings-section">
        ...
        <div className="settings-button-grid">
          <button
            className={`settings-button ${settings.timerMode === TimerModes.TIMER ? 'active' : ''}`}
          ...
          <button
            className={`settings-button ${settings.timerMode === TimerModes.STOPWATCH ? 'active' : ''}`}
          ...
          <button
            className={`settings-button ${settings.timerMode === TimerModes.ALARM ? 'active' : ''}`}
      ...
      {settings.timerMode === TimerModes.TIMER && (
        <div className="settings-section">
          <div className="settings-section-title">Input Method</div>
          <div className="settings-button-grid">
            <button
              className={`settings-button ${settings.inputMethod === InputMethods.DIRECT ? 'active' : ''}`}
            ...
            <button
              className={`settings-button ${settings.inputMethod === InputMethods.DIAL ? 'active' : ''}`}
            ...
            <button
              className={`settings-button ${settings.inputMethod === InputMethods.SCROLL ? 'active' : ''}`}
